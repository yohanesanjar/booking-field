            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div class="chart-pie pt-4 pb-2">
                        <canvas id="myPieChart" data-labels="{{ $labels }}" data-data="{{ $data }}"></canvas>
                    </div>
                    <div class="mt-4 text-center small">
                        <span class="mr-2">
                            <i class="fas fa-circle text-primary"></i> {{ $labels[0] }}
                        </span>
                        <span class="mr-2">
                            <i class="fas fa-circle text-success"></i> {{ $labels[1] }}
                        </span>
                    </div>
                </div>
            </div>
