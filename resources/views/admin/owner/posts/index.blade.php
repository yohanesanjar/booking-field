...
@section('content')
    ...
    @endif
    <div class="py-3">
        <a href="{{ route('owner.postCreate') }}" class="btn btn-primary">Tambah</a>
    </div>
    <!-- Content Row -->
    <div class="row">
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="d-flex justify-content-center gap-1">
                                    <a href="{{ route('owner.postDetail', $post->id) }}" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Detail" class="btn btn-sm btn-primary"><i class="fa fa-eye"></i></a>
                                    <a href="{{ route('owner.postEdit', $post->id) }}" data-bs-toggle="tooltip"
                                        data-bs-placement="top" data-bs-title="Edit" class="btn btn-sm btn-warning"><i
                                            class="fa fa-edit"></i>
                                    </a>

                                    <form class="deleteForm" action="{{ route('owner.postDelete', $post->id) }}"
                                        method="POST">
                                        @csrf
                                        @method('DELETE')
